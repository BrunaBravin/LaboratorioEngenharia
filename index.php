...
<body class="container">
    ...
    <h5 class="text-secondary">Bruna Bravin Bueno</h2>
    <div class="container-md">
        <div class="atividade">
        <i class="fa-solid fa-code"></i><a class="linkAtividade" href="./Aula1Jogo.html">Aula 01 - Jogo</a><br>
        </div>
        <div class="atividade">
        <i class="fa-solid fa-code"></i><a class="linkAtividade" href="./Aula2Dataehora.html">Aula 02 - Data</a><br>
        </div>
        <div class="atividade">
        <i class="fa-solid fa-code"></i><a class="linkAtividade" href="./Aula2Relogio.html">Aula 02 - Relógio</a><br>
        </div>
        <div class="atividade">
